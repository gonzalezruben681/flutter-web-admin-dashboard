...
class AuthProvider extends ChangeNotifier {
  ...
  login(String email, String password) {
    ...
    CafeApi.post('/auth/login', data).then((json) {
      ...
      LocalStorage.prefs.setString('token', authResponse.token); //guardar  el token en localstorage
...
// envio de segmento y la data
    CafeApi.post('/usuarios', data).then((json) {
      ...
      CafeApi.configureDio(); //para utilizar el nuevo JWT generado en todas las peticiones
      notifyListeners();
    }).catchError((e) {
      print('error en: $e');
      NotificationsService.showSnackbarError('Usuario / Password no válidos');
